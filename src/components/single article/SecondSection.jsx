    ...
    return (
        <section className="bg-white">
            <div className="lg:w-3/4 md:w-11/12 md:mx-auto pb-10">
                <div className=" md:h-[500px] h-[300px]"><img src={article.img1} alt="premiere image" className="w-full h-full"/></div>
                <div className="md:w-3/4 mx-auto w-11/12 flex flex-col gap-4 my-8">
                    <p> {article.p1} </p>
                    <p> {article.p2} </p>
                    <p> {article.p3} </p>
                </div>
                <div className="md:w-4/5 mx-auto w-11/12  md:h-[390px] h-[250px]"><img src={article.img2} alt="deuxieme image" className="w-full h-full" /></div>
                <div className="md:w-3/4 mx-auto w-11/12 flex flex-col gap-4 my-8">
                    <p> {article.p4} </p>
                    <p> {article.p5} </p>
                </div>
