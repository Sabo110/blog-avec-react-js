...
function ArticleBlock(props) {
    ...
    return (
        <div className="bg-white md:ps-4 md:py-2 rounded shadow-md md:flow-root border-box flex flex-col cursor-pointer" onClick={handleNavigate}>
            <img src={article.img1} alt="miniature" className="md:float-right md:m-4 lg:w-[300px] lg:h-[211.85px] md:w-[210px] md:h-[170px] h-[180px] w-full order-last rounded-b-lg md:rounded-b-none" />
            <div className="p-4">
